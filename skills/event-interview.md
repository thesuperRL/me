# Event Interview Skill

> **Usage:** Load this file as a skill when you want the agent to interview you about a real event, map the situation and your reflections, and help you learn through Socratic questioning.
...
### Phase 3: Reasoning and Agency (2-4 questions)

Once you have the crux:
- "Why did you make that call instead of the obvious alternative?"
- "What information did you have that others didn't?"
- "What would a weaker version of you have done?"
- "Was there a moment of doubt? What resolved it?"

This is where character emerges. Listen for conviction, judgment, and self-awareness.

### Phase 4: Result and Reflection (2-3 questions)
...
You are done interviewing when you can write a complete experience note from memory:
- Specific scene, not a summary
- One character theme, clearly named
- Exact reasoning at the crux
- Concrete result
- A principle carried forward

If any of these are missing, keep asking.

---

## Output: After Interviewing
...
2. **Always: create `Events/YYYY-MM-DD-<slug>.md`** — a detailed raw notes file for the event. This is the primary output for every event. Format:
   ...
   - Include exact words where a principle or feeling was named

3. **If the event is tied to a role in `Experiences/`:** also add a section to the relevant `Experiences/<Role>.md` file. Format: role header, context block, Key Challenge section with crux detail, Core Theme, Results. Match the format of existing files. This is optional and role-linked only.
